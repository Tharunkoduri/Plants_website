...
export function TrendingGardening() {
  ...
  return (
    <div>
      ...
      <p className="text-center fw-semibold text-secondary">Trending in Gardening: Your Ultimate Plant Collection Discover the latest trends in gardening with our curated collection of plants</p>
